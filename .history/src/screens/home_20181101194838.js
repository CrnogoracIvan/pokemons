...
class home extends Component {
    ...
    renderPokemon(){
      console.log('usao u render: ', this.state.pokemons[selectedData]);
        ...
        return(
          <View>
            <Image 
              ...
              source={{uri: this.state.pokemons[selectedData0].url }}
            />
            <Text> {this.state.pokemons[selectedData].name} </Text>
          </View>
